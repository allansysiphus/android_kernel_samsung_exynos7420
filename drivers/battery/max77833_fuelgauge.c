...
static int max77833_fuelgauge_probe(struct platform_device *pdev)
{
	...
	psy_fg_d->name		= "max77833-fuelgauge";
	psy_fg_d->type		= POWER_SUPPLY_TYPE_UNKNOWN;
	psy_fg_d->get_property	= max77833_fg_get_property;
	psy_fg_d->set_property	= max77833_fg_set_property;
	psy_fg_d->properties	= max77833_fuelgauge_props;
	psy_fg_d->num_properties = ARRAY_SIZE(max77833_fuelgauge_props);
