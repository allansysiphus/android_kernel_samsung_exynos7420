...
#define __max77833_charger_probe_define(_module_) \
...
static int max77833_charger_probe(struct platform_device *pdev)
{
	...
	__max77833_charger_probe_define(chg);
	psy_chg_d->name		= "max77833-charger";
	psy_chg_d->type		= POWER_SUPPLY_TYPE_UNKNOWN;
	psy_chg_d->get_property	= max77833_chg_get_property;
	psy_chg_d->set_property	= max77833_chg_set_property;
	psy_chg_d->properties	= max77833_charger_props;
	psy_chg_d->num_properties	= ARRAY_SIZE(max77833_charger_props);

	__max77833_charger_probe_define(otg);
	psy_otg_d->name		= "otg";
	psy_otg_d->type		= POWER_SUPPLY_TYPE_OTG;
	psy_otg_d->get_property	= max77833_otg_get_property;
	psy_otg_d->set_property	= max77833_otg_set_property;
	psy_otg_d->properties		= max77833_otg_props;
	psy_otg_d->num_properties	= ARRAY_SIZE(max77833_otg_props);
